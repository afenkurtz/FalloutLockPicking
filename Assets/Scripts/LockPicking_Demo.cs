...
public class LockPicking_Demo : MonoBehaviour
{
    ...
    [Header("Debug")]
    [Tooltip("If true, unlocking the lock will just keep generating new locks.")]
    [SerializeField] private bool keepGeneratingLocks = false;
    ...
    [SerializeField] private float maxPickStrength = 10.0f;
    ...
    private float advancedMultiplier = 0.75f;
   ...
   private void EscapeInput()
    {
        ...
        {
            Managers.Lockpicking.EndLockpicking();
        }
    }
        ...
        if (lockLerp >= maxRotation - 1)
        {
            if (eulerAngle < unlockRange.y && eulerAngle > unlockRange.x)
            {
                ...
                else
                {
                    ...
                    Managers.Lockpicking.CurrentDoorUnlocked();
                    Managers.Lockpicking.EndLockpicking();
                }
            }
    ...
    public void SetDifficulty(LockpickingDifficulties difficulty)
    {
        ...
        // need to generate a new lock to update any difficulty changes
        NewLock();
    }
}
