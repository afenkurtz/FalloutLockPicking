...
public class LockPick_andSound : MonoBehaviour
{
    public Camera cam;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.A) || Input.GetKeyDown(KeyCode.S) || Input.GetKeyDown(KeyCode.D))
        {
            ...
            audioSource.Stop();
            audioSource.clip = longClips[Random.Range(0, longClips.Length)];
            audioSource.Play();
        }
        ...
        if(lockLerp >= maxRotation - 1)
        {
            ...
            else if (keyPressTime == 1)
            {
                ...
                audioSource.clip = shortClips[Random.Range(0, longClips.Length)];
                audioSource.Play();
